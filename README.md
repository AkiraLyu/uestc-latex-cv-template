...
```tex
\newcommand{\schoolNameCH}{电子科技大学}
\newcommand{\schoolNameEN}{University of Electronic Science and Technology of China}
\newcommand{\departmentNameCH}{自动化工程学院}
\newcommand{\departmentNameEN}{School of Automation Engineer}
```
...
模板默认主题色为深蓝（`#002554`），源自 [西北工业大学中文 CV 模板](https://www.overleaf.com/latex/templates/npu-cv/mncqzxhvfzrx) 的页眉页脚设计。  
