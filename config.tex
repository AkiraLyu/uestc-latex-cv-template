...
% 学校、院系、专业等
\newcommand{\schoolNameCH}{电子科技大学} % 学校中文名
\newcommand{\schoolNameEN}{University of Electronic Science and Technology of China} % 学校英文名
\newcommand{\departmentNameCH}{自动化工程学院} % 院系中文名
\newcommand{\departmentNameEN}{School of Automation Engineering} % 院系英文名
...
% 科研成果
\def\needPublication{false} % 是否需要科研成果模块，true/false
...
% 所获荣誉
\def\needHonors{false} % 是否需要所获荣誉模块，true/false
...
% 页眉与校徽与主题色
\def\useDefaultTheme{false} % 是否使用默认主题，详见 README.md；建议：true
...
\def\schoolLogoWidth{0.25} % 校徽+校名占行宽的比例（根据logo宽度调整，4字学校大约0.15，6字学校大约0.2，）
...
\definecolor{WHU_Blue}{HTML}{004098}
...
% 字体设置
% 参见 README.md -> 自定义字体
\def\useDefaultFont{true} % 是否使用系统默认字体，详见 README.md
...
\newif\ifuseDefaultFont
\useDefaultFonttrue   % 控制开关
\ifuseDefaultFont
    \setmainfont{LXGW WenKai Screen} % 当使用系统默认字体时，请在这里设置
\fi